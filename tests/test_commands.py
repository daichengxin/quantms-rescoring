...
def test_annotator_train_rt():
    ...
    annotator = FeatureAnnotator(feature_generators="ms2pip,deeplc", ms2pip_model="TMT", ms2pip_model_path="models",
                                 ms2_tolerance=0.05, calibration_set_size=0.15, skip_deeplc_retrain=False, processes=2,
                                 log_level="INFO", spectrum_id_pattern="(.*)", psm_id_pattern="(.*)")
...
def test_idxmlreader_filtering():
    ...
    annotator = FeatureAnnotator(feature_generators="ms2pip,deeplc",
                                 only_features="DeepLC:RtDiff,DeepLC:PredictedRetentionTimeBest,Ms2pip:DotProd",
                                 ms2pip_model="TMT", ms2pip_model_path="models", ms2_tolerance=0.2,
                                 calibration_set_size=0.15, skip_deeplc_retrain=True, processes=2, log_level="INFO",
                                 spectrum_id_pattern="(.*)", psm_id_pattern="(.*)")
    annotator.build_idxml_data(idxml_file, mzml_file)
    annotator.annotate()
...
def test_idxmlreader_wrong_model():
    ...
    annotator = FeatureAnnotator(feature_generators="ms2pip,deeplc",
                                 only_features="DeepLC:RtDiff,DeepLC:PredictedRetentionTimeBest,Ms2pip:DotProd",
                                 ms2pip_model="CID-TMT", ms2pip_model_path="models", ms2_tolerance=0.2,
                                 calibration_set_size=0.15, skip_deeplc_retrain=True, processes=2, log_level="INFO",
                                 spectrum_id_pattern="(.*)", psm_id_pattern="(.*)", find_best_model=True)
    annotator.build_idxml_data(idxml_file=idxml_file, spectrum_path=mzml_file)
    annotator.annotate()
...
def test_idxmlreader_failing_help():
    ...
    annotator = FeatureAnnotator(feature_generators="ms2pip,deeplc",
                                 only_features="DeepLC:RtDiff,DeepLC:PredictedRetentionTimeBest,Ms2pip:DotProd",
                                 ms2pip_model="HCD2021", ms2pip_model_path="models", ms2_tolerance=0.05,
                                 calibration_set_size=0.15, skip_deeplc_retrain=True, processes=2, log_level="INFO",
                                 spectrum_id_pattern="(.*)", psm_id_pattern="(.*)")
    annotator.build_idxml_data(idxml_file, mzml_file)
    annotator.annotate()
